...
public class ShapemultiThreading extends Application {

    public static void main(String[] args) {
        launch(args);
    }

    public Canvas c2w_canvas;
        ...
        switch (c2w_artType) {
            ...
            case 1:
                for (int i = 0; i < 200; i++) {
                    ...
                    Color c2w_radomHue = Color.hsb(360 * Math.random(), 1, 1);
                    c2w_g.setStroke(c2w_radomHue);
            ...
            default:
                ...
                for (int i = 0; i < 25; i++) {
                    ...
                    c2w_g.fillRect(c2w_centerX - size / 2, c2w_centerY - size / 2, size, size);
                    c2w_g.strokeRect(c2w_centerX - size / 2, c2w_centerY - size / 2, size, size);
                }
                break;
        }
    }
